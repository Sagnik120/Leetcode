<h2><a href="https://leetcode.com/problems/cells-with-odd-values-in-a-matrix/solutions/8386407/simple-python-code-by-abinish-99ie/?envType=problem-list-v2&envId=math">1378. Cells with Odd Values in a Matrix</a></h2><h3>Easy</h3><hr><p>There is an <code>m x n</code> matrix that is initialized to all <code>0</code>&#39;s. There is also a 2D array <code>indices</code> where each <code>indices[i] = [r<sub>i</sub>, c<sub>i</sub>]</code> represents a <strong>0-indexed location</strong> to perform some increment operations on the matrix.</p>
